  ...
  },
  {
    ...
    subMenus: [
      ...
      },
      {
        id: nanoid(5),
        label: 'Tây Ban Nha',
        path: '/quoc-gia/tay-ban-nha',
      },
      {
        id: nanoid(5),
        label: 'Thổ Nhĩ Kỳ',
        path: '/quoc-gia/tho-nhi-ky',
      },
      {
        id: nanoid(5),
        label: 'Hà Lan',
      ...
      },
      {
        id: nanoid(5),
        label: 'Mexico',
        path: '/quoc-gia/mexico',
      },
      {
        id: nanoid(5),
        label: 'Ba Lan',
        path: '/quoc-gia/ba-lan',
      },
      {
        id: nanoid(5),
        label: 'Úc',
      ...
      },
      {
        id: nanoid(5),
        label: 'Thụy Điển',
        path: '/quoc-gia/thuy-dien',
      },
      {
        id: nanoid(5),
        label: 'Malaysia',
        path: '/quoc-gia/malaysia',
      },
      {
        id: nanoid(5),
        label: 'Brazil',
        path: '/quoc-gia/brazil',
      },
      {
        id: nanoid(5),
        label: 'Philippines',
      ...
      },
      {
        id: nanoid(5),
        label: 'Thụy Sĩ',
        path: '/quoc-gia/thuy-si',
      },
      {
        id: nanoid(5),
        label: 'Châu Phi',
        path: '/quoc-gia/chau-phi',
      },
      {
        id: nanoid(5),
        label: 'Nam Phi',
        path: '/quoc-gia/nam-phi',
      },
      {
        id: nanoid(5),
        label: 'Ukraina',
        path: '/quoc-gia/ukraina',
      },
      {
        id: nanoid(5),
        label: 'Ả Rập Xê Út',
        path: '/quoc-gia/a-rap-xe-ut',
      },
      {
        id: nanoid(5),
        label: 'Bỉ',
      ...
      },
      {
        id: nanoid(5),
        label: 'Ireland',
        path: '/quoc-gia/ireland',
      },
      {
        id: nanoid(5),
        label: 'Colombia',
        path: '/quoc-gia/colombia',
      },
      {
        id: nanoid(5),
        label: 'Phần Lan',
        path: '/quoc-gia/phan-lan',
      },
      {
        id: nanoid(5),
        label: 'Việt Nam',
      ...
      },
      {
        id: nanoid(5),
        label: 'Hy Lạp',
        path: '/quoc-gia/hy-lap',
      },
      {
        id: nanoid(5),
        label: 'Nigeria',
        path: '/quoc-gia/nigeria',
      },
      {
        id: nanoid(5),
        label: 'Argentina',
        path: '/quoc-gia/argentina',
      },
      {
        id: nanoid(5),
        label: 'Singapore',
        path: '/quoc-gia/singapore',
      },
    ],
  },
];
