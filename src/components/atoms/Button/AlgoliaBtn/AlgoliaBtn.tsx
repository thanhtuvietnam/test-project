...
const AlgoliaBtn: React.FC<AlgoliaBtnProps> = ({ children, className }) => {
  return (
    <button
      role="button"
      className={cn(
        ...
        // color
        'bg-gradient-to-r font-mono leading-none text-white no-underline shadow-[rgba(45,35,66,0.4)_0_2px_4px,rgba(45,35,66,0.3)_0_7px_13px_-3px,rgba(58,65,111,0.5)_0_-3px_0_inset]',
        // shadow
