        ...
        {subMenus[tab] && openSubmenu === tab && (
          ...
          >
            <motion.div
              ...
              transition={transition}
              variants={subMenuVariants}
              className="absolute -top-3 left-9 h-0 w-0 -translate-x-1/2 border-b-8 border-l-8 border-r-8 border-transparent border-b-main-deepCerise-500 dark:border-b-semantic-springGreen"
