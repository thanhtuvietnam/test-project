  ...
  return (
    <div className="w-full md:w-1/2 lg:w-1/3">
      ...
      <div className={cn('center-flex w-full')}>
        <Link href="/" className={cn('carouselBtn second-themes from-gray-700 to-black/30', 'bounce-effect')}>
          <icons.FaPlay />
          <span>Watch Movie</span>
        </Link>
        <Link href={`/film-info/${slug}`} className={cn('carouselBtn group/button-two border border-main-deepCerise-350 bg-bglight/20 from-gray-500 to-black/70 dark:border-main-summerSky-500', 'bounce-effect')}>
